...
public class RecipeTests extends CloudbreakTest{
    ...
    public static final String VALID_RECIPE_URI = "https://gist.githubusercontent.com/aszegedi/4fc4a6a2fd319da436df6441c04c68e1/raw/5698a1106a2365eb543e9d3c830e14f955882437/post-install.sh";
    ...
    @Test
    public void createValidRecipePostAmbari() throws Exception {
    ...
    @Test
    public void createValidRecipePreAmbari() throws Exception {
        given(CloudbreakClient.isCreated());
        given(Recipe.request()
    ...
    @Test
    public void createValidRecipePostCluster() throws Exception {
        given(CloudbreakClient.isCreated());
        given(Recipe.request()
    ...
    @Test
    public void createValidRecipePreTerm() throws Exception {
        given(CloudbreakClient.isCreated());
        given(Recipe.request()
    ...
    @Test
    public void createValidRecipeFile() throws Exception {
        given(CloudbreakClient.isCreated());
        given(Recipe.request()
    ...
    @Test(expectedExceptions = BadRequestException.class)
    public void createInvalidRecipeShortName() throws Exception {
        given(CloudbreakClient.isCreated());
        given(Recipe.request()
    ...
    @Test(expectedExceptions = BadRequestException.class)
    public void createInvalidRecipeLongDescr() throws Exception {
        given(CloudbreakClient.isCreated());
        given(Recipe.request()
                .withName(VALID_RECIPE_NAME)
                .withDescription(createLongString(1001))
                .withRecipeType(RecipeType.POST_AMBARI_START)
                .withUri(VALID_RECIPE_URI)
        );
        when(Recipe.post());
    ...
    @Test
    public void createDeleteValidCreateAgain() throws Exception {
        given(CloudbreakClient.isCreated());
    ...
    private String createLongString(Integer length){
